...
enum DGUSLCD_Screens : uint8_t {
  ...
  DGUSLCD_SCREEN_MANUAL_LEVELING = 82
};
...
// Manual bed leveling
constexpr uint16_t VP_MANUAL_LEVEL_BUTTON = 0x2434; 
constexpr uint16_t VP_MANUAL_LEVEL_BUTTON_ACTION_HOME = 0; 
constexpr uint16_t VP_MANUAL_LEVEL_BUTTON_ACTION_CENTER = 1; 
constexpr uint16_t VP_MANUAL_LEVEL_BUTTON_ACTION_FRONT_LEFT = 2; 
constexpr uint16_t VP_MANUAL_LEVEL_BUTTON_ACTION_FRONT_RIGHT = 3; 
constexpr uint16_t VP_MANUAL_LEVEL_BUTTON_ACTION_REAR_RIGHT = 4; 
constexpr uint16_t VP_MANUAL_LEVEL_BUTTON_ACTION_REAR_LEFT = 5; 
constexpr uint16_t VP_MANUAL_LEVEL_BUTTON_ACTION_DOWN = 6; 
constexpr uint16_t VP_MANUAL_LEVEL_BUTTON_ACTION_UP = 7; 